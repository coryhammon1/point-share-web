import { e as __extends$1, a as __awaiter, b as __generator, g as __spreadArrays } from '../common/tslib.es6-84f6ac32.js';
import { g as getUA, d as isMobileCordova, e as isReactNative, h as isElectron, j as isIE, k as isUWP, a as isBrowserExtension, l as LogLevel, L as Logger, C as Component, f as firebase$1 } from '../common/index.esm-5bdff81d.js';
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var I$1 = new Logger("@firebase/firestore");
 ...
 */ function E$1(t) {
    ...
    if (I$1.logLevel <= LogLevel.DEBUG) {
        var i = n.map(A$1);
        I$1.debug.apply(I$1, __spreadArrays([ "Firestore (8.2.1): " + t ], i));
    }
}
...
function T$1(t) {
    ...
    if (I$1.logLevel <= LogLevel.ERROR) {
        var i = n.map(A$1);
        I$1.error.apply(I$1, __spreadArrays([ "Firestore (8.2.1): " + t ], i));
    }
}
...
function N$1(t) {
    ...
    if (I$1.logLevel <= LogLevel.WARN) {
        var i = n.map(A$1);
        I$1.warn.apply(I$1, __spreadArrays([ "Firestore (8.2.1): " + t ], i));
    }
}
 ...
 */ function S$1(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (8.2.1) INTERNAL ASSERTION FAILED: " + t;
...
var V$1 = {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new M$1(V$1.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function F$1() {
    if ("undefined" == typeof Uint8Array) throw new M$1(V$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function j() {
    if ("undefined" == typeof atob) throw new M$1(V$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
...
var H$1 = function(t, e) {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.F !== e ? (E$1("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (x$1("string" == typeof n.accessToken), new H$1(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.O = function() {
        ...
        return x$1(null === t || "string" == typeof t), new K$1(t);
    }, t;
}(), Q$1 = /** @class */ function() {
    function t(t, e) {
...
/** A CredentialsProvider that always yields an empty token. */ $.U = -1;
...
var X$1 = /** @class */ function() {
     ...
     */
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new M$1(V$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new M$1(V$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new M$1(V$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new M$1(V$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
    ...
    e.ct = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var u = o[i];
            if (u.indexOf("//") >= 0) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid segment (" + u + "). Paths must not contain // in them.");
    ...
    e._t = function(t) {
        for (var n = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            n.push(r), r = "";
        }, u = !1; i < t.length; ) {
            var s = t[i];
            if ("\\" === s) {
                if (i + 1 === t.length) throw new M$1(V$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new M$1(V$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === s ? (u = !u, i++) : "." !== s || u ? (r += s, i++) : (o(), i++);
        }
        if (o(), u) throw new M$1(V$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new e(n);
    }, e.at = function() {
        return new e([]);
    }, e;
...
var Bt = /** @class */ function(t) {
     ...
     */    return __extends$1(e, t), e.create = function(t, n, r) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.Ct(_t(e, this.value)) : null !== e && wt(this.value) === wt(e) && this.Ct(_t(e, this.value));
 ...
 */ function re(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.ht() ? it.J(it.dt(u.referenceValue), n.key) : _t(u, n.field(o.field)), 
 ...
 */ function pe(t) {
    ...
    if (null === e.Ft) {
        ...
        n.ht() || e.Ft.push(new ee(n)), e.Ft.push(new ee(rt.lt(), "asc" /* ASCENDING */)); else {
 ...
 */ function de(t) {
    var e = D$1(t);
    if (!e.Ot) if ("F" /* First */ === e.limitType) e.Ot = Ft(e.path, e.collectionGroup, pe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
...
function Ie(t, e, n) {
    var r = t.field.ht() ? it.J(e.key, n.key) : function(t, e, n) {
        ...
        return null !== r && null !== i ? _t(r, i) : S$1();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 * limitations under the License.
 */
/** Represents a transform within a TransformMutation. */ var Ae = function() {
 ...
 */ function Se(t, e, n) {
    ...
    }(n, e) : t instanceof Oe ? Pe(t, e) : t instanceof Ce ? Le(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = De(t, e), r = Ve(n) + Ve(t.Qt);
 ...
 */ function xe(t, e, n) {
    ...
    // applications.
    return t instanceof Oe ? Pe(t, e) : t instanceof Ce ? Le(t, e) : n;
}
...
/** Transforms an array value via a remove operation. */ var Ce = /** @class */ function(t) {
    function e(e) {
        var n = this;
        return (n = t.call(this) || this).elements = e, n;
    }
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var Ue = function(t, e) {
 ...
 */ function Ge(t, e, n) {
    return t instanceof We ? function(t, e, n) {
        ...
        if (n.transformResults) {
            var i = $e(t.fieldTransforms, e, n.transformResults);
        ...
        var r = Ye(t, e, n.transformResults ? $e(t.fieldTransforms, e, n.transformResults) : []);
        return new Vt(t.key, n.version, r, {
            hasCommittedMutations: !0
        });
 ...
 */ function Be(t, e, n, r) {
    return t instanceof We ? function(t, e, n, r) {
        ...
        if (t.fieldTransforms) {
            var o = Xe(t.fieldTransforms, n, e, r);
    ...
    }(t, e, r, n) : t instanceof Qe ? function(t, e, n, r) {
        if (!je(t.Gt, e)) return e;
        var i = Je(e), o = Ye(t, e, Xe(t.fieldTransforms, n, e, r));
        return new Vt(t.key, i, o, {
            bt: !0
        });
    }(t, e, r, n) : function(t, e) {
        return je(t.Gt, e) ? new Mt(t.key, Z$1.min()) : e;
    }(t, e);
}
 ...
 */ function Ke(t, e) {
    return void 0 !== t.fieldTransforms ? function(t, e) {
        for (var n = null, r = 0, i = t; r < i.length; r++) {
            var o = i[r], u = e instanceof Vt ? e.field(o.field) : void 0, s = De(o.transform, u || null);
            null != s && (n = null == n ? (new Ct).set(o.field, s) : n.set(o.field, s));
        }
        return n ? n.yt() : null;
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && C(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Oe && e instanceof Oe || t instanceof Ce && e instanceof Ce ? C(t.elements, e.elements, bt) : t instanceof Re && e instanceof Re ? bt(t.Qt, e.Qt) : t instanceof ke && e instanceof ke;
...
function $e(t, e, n) {
    ...
    for (var i = 0; i < n.length; i++) {
        ...
        e instanceof Vt && (s = e.field(o.field)), r.push(xe(u, s, n[i]));
    }
    return r;
}
 ...
 */ function Xe(t, e, n, r) {
    for (var i = [], o = 0, u = t; o < u.length; o++) {
        ...
        n instanceof Vt && (c = n.field(s.field)), null === c && r instanceof Vt && (
        // If the current document does not contain a value for the mutated
        // field, use the value that existed before applying this mutation
        // batch. This solves an edge case where a PatchMutation clears the
        // values in a nested map before the TransformMutation is applied.
        c = r.field(s.field)), i.push(Se(a, c, e));
    }
    return i;
}

function Ze(t, e, n) {
    for (var r = new Ct(e), i = 0; i < t.length; i++) {
        var o = t[i];
        r.set(o.field, n[i]);
    }
    return r.yt();
 ...
 */ var Tn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, xn.Be(e, n)), new t(Z$1.min(), r, En(), dn(), In());
    }, t;
}(), xn = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.wn = function(t) {
        for (var e = 0, n = t.We; e < n.length; e++) {
            var r = n[e];
            t.je instanceof Vt ? this.En(r, t.je) : t.je instanceof Mt && this.Tn(r, t.key, t.je);
        }
    ...
    t.prototype.yn = function(t) {
        ...
        if (r) {
            ...
            if (Gt(i)) if (0 === n) {
                ...
                // queries.
                var o = new it(i.path);
                this.Tn(e, o, new Mt(o, Z$1.min()));
            } else x$1(1 === n); else this.Vn(e) !== n && (
    ...
    t.prototype.pn = function(t) {
        ...
        this.ln.forEach((function(r, i) {
            ...
            if (o) {
                if (r.qe && Gt(o.target)) {
                    ...
                    null !== e._n.get(u) || e.bn(i, u) || e.Tn(i, u, new Mt(u, t));
                }
        ...
        return this._n = dn(), this.fn = Ln(), this.dn = new hn(P$1), i;
    }, 
    /**
...
function Hn(t, e) {
    var n = Bn(e);
    if (n.get(1) !== t.T.projectId) throw new M$1(V$1.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.T.projectId);
    if (n.get(3) !== t.T.database) throw new M$1(V$1.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.T.database);
    return new it(Yn(n));
}
...
function Yn(t) {
    return x$1(t.length > 4 && "documents" === t.get(4)), t.X(5)
...
function tr(t, e) {
    ...
    }(e.currentDocument) : Fe.Wt(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) x$1("REQUEST_TIME" === e.setToServerValue), n = new ke; else if ("appendMissingElements" in e) {
 ...
 */ var vr = function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Fn && S$1(), this.Fn = !0, this.Nn ? this.error ? this.On(n, this.error) : this.kn(e, this.result) : new t((function(t, i) {
            r.Cn = function(n) {
                r.kn(e, n).next(t, i);
            }, r.xn = function(e) {
                r.On(n, e).next(t, i);
    ...
    /** Returns true if IndexedDB is available in the current environment. */ t.Wn = function() {
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            "VersionError" === n.name ? r(new M$1(V$1.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new br(t, n));
...
function Nr(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(r) >= 0) {
            ...
            var i = new M$1("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + r + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return Tr || (Tr = !0, 
 ...
 */ var Ar = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.As && (this.clearTimeout(), this.Ts.reject(new M$1(V$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function Sr(t, e) {
    if (T$1("AsyncQueue", e + ": " + t), Ir(t)) return new M$1(V$1.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Dr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", kr = /** @class */ function() {
    function t() {
        this.Vs = [];
    }
 ...
 */
function Or(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = Cr(e)), e = Pr(t.get(n), e);
    return Cr(e);
}
 ...
 */ function Lr(t) {
    ...
    var e = t.length;
    if (x$1(e >= 2), 2 === e) return x$1("" === t.charAt(0) && "" === t.charAt(1)), et.at();
...
/** Name of the IndexedDb object store.  */ Kr.store = "targetDocuments", 
...
/** Name of the IndexedDb object store. */ Jr.store = "collectionParents", 
...
// Visible for testing
var $r = __spreadArrays(__spreadArrays(__spreadArrays(__spreadArrays([ Mr.store, Ur.store, qr.store, zr.store, Br.store, Vr.store, Hr.store, Kr.store ], [ Wr.store ]), [ Gr.store ]), [ Jr.store ]), [ Qr.store, Yr.store ]), Xr = /** @class */ function(t) {
    function e(e, n) {
        var r = this;
 ...
 */ var ti = /** @class */ function() {
     ...
     */
    function t(t, e, n, r) {
        this.batchId = t, this.Ds = e, this.baseMutations = n, this.mutations = r
        /**
    ...
    return t.prototype.Cs = function(t, e, n) {
        for (var r = n.xs, i = 0; i < this.mutations.length; i++) {
    ...
    t.prototype.Ns = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = Be(i, e, e, this.Ds));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, u = 0, s = this.mutations; u < s.length; u++) {
            var a = s[u];
            a.key.isEqual(t) && (e = Be(a, e, o, this.Ds));
        }
        return e;
    }, 
    /**
...
/** Decodes a remote document from storage locally to a Document. */ function ri(t, e) {
    if (e.document) return Xn(t.Ms, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        var n = it.Tt(e.noDocument.path), r = ai(e.noDocument.readTime);
        return new Mt(n, r, {
    ...
    if (e.unknownDocument) {
        ...
        r = ai(e.unknownDocument.version);
        return new Ut(i, r);
    }
    return S$1();
}
...
/** Encodes a document for storage locally. */ function ii(t, e, n) {
    ...
    if (e instanceof Vt) {
        ...
        }(t.Ms, e), u = e.hasCommittedMutations;
        return new zr(
        /* unknownDocument= */ null, 
        /* noDocument= */ null, o, u, r, i);
    }
    if (e instanceof Mt) {
        var s = e.key.path.rt(), a = si(e.version);
        u = e.hasCommittedMutations;
        return new zr(
        /* unknownDocument= */ null, new Fr(s, a), 
        /* document= */ null, u, r, i);
    }
    if (e instanceof Ut) {
        var c = e.key.path.rt(), f = si(e.version);
        return new zr(new jr(c, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function ui(t) {
    var e = new X$1(t[0], t[1]);
    return Z$1.W(e);
}

function si(t) {
    var e = t.G();
    return new Rr(e.seconds, e.nanoseconds);
}

function ai(t) {
    var e = new X$1(t.seconds, t.nanoseconds);
    return Z$1.W(e);
}
...
/** Decodes a DbMutationBatch into a MutationBatch */ function ci(t, e) {
    ...
    var o = e.mutations.map((function(e) {
        return tr(t.Ms, e);
    })), u = X$1.fromMillis(e.localWriteTimeMs);
    return new ti(e.batchId, u, n, o);
}

/** Decodes a DbTarget into TargetData */ function fi(t) {
    var e, n, r = ai(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? ai(t.lastLimboFreeSnapshotVersion) : Z$1.min();
    return void 0 !== t.query.documents ? (x$1(1 === (n = t.query).documents.length), 
    e = de(se(Wn(n.documents[0])))) : e = function(t) {
        return de(rr(t));
    }(t.query), new _e(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, R$1.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function hi(t, e) {
    var n, r = si(e.Mt), i = si(e.lastLimboFreeSnapshotVersion);
    n = Gt(e.target) ? er(t.Ms, e.target) : nr(t.Ms, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Br(e.targetId, jt(e.target), r, o, e.sequenceNumber, i, n);
}
 ...
 */ var pi = /** @class */ function() {
    ...
    return t.prototype.Ls = function(t, e) {
        ...
        var n;
        /** Encodes a DbNamedQuery to a NamedQuery. */    }, t.prototype.Bs = function(t, e) {
 ...
 */ function di(t) {
    return Zr(t, Qr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function vi(t) {
    return Zr(t, Yr.store);
}
 ...
 */ var yi = /** @class */ function() {
    ...
    return t.prototype.Qs = function(t, e) {
        return this.Us.add(e), yr.resolve();
    }, t.prototype.Ks = function(t, e) {
        return yr.resolve(this.Us.getEntries(e));
    }, t;
}(), mi = /** @class */ function() {
    function t() {
        this.index = {};
     ...
     */    return t.prototype.Qs = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return wi(t).os(r).next((function(t) {
 ...
 */ Ii.ti = 10, Ii.ei = 1e3, Ii.ni = new Ii(41943040, Ii.ti, Ii.ei), Ii.si = new Ii(-1, 0, 0);
...
var Ei = /** @class */ function() {
    ...
    return t.prototype.get = function(t) {
        var e = this.ii(t), n = this.oi[e];
        if (void 0 !== n) for (var r = 0, i = n; r < i.length; r++) {
            var o = i[r], u = o[0], s = o[1];
            if (this.ri(u, t)) return s;
        }
    }, t.prototype.has = function(t) {
        return void 0 !== this.get(t);
    }, 
    /** Put this key and value in the map. */ t.prototype.set = function(t, e) {
        var n = this.ii(t), r = this.oi[n];
        if (void 0 !== r) {
            for (var i = 0; i < r.length; i++) if (this.ri(r[i][0], t)) return void (r[i] = [ t, e ]);
            r.push([ t, e ]);
        } else this.oi[n] = [ [ t, e ] ];
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        ...
        for (var r = 0; r < n.length; r++) if (this.ri(n[r][0], t)) return 1 === n.length ? delete this.oi[e] : n.splice(r, 1), 
        !0;
        return !1;
    }, t.prototype.forEach = function(t) {
        ut(this.oi, (function(e, n) {
    ...
    t.prototype.fi = function(t, e) {
        void 0 === e && (e = null), this.li(), this.ci.set(t, {
            _i: null,
            readTime: e
        });
    }, 
    ...
    t.prototype.di = function(t, e) {
        this.li();
        var n = this.ci.get(e);
        return void 0 !== n ? yr.resolve(n._i) : this.wi(t, e);
    }, 
    /**
    ...
    /** Helper to assert this.changes is not null  */ t.prototype.li = function() {}, 
    t;
}();
 ...
 */
function Ni(t, e, n) {
    var r = t.store(Ur.store), i = t.store(qr.store), o = [], u = IDBKeyRange.only(n.batchId), s = 0, a = r.ls({
        range: u
    }, (function(t, e, n) {
        return s++, n.delete();
    }));
    ...
    for (var c = [], f = 0, h = n.mutations; f < h.length; f++) {
        var l = h[f], p = qr.key(e, l.key.path, n.batchId);
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ var Si = /** @class */ function() {
    function t(
    /**
     ...
     */
    t, e, n, r) {
        this.userId = t, this.Kt = e, this.Ii = n, this.mi = r, 
        /**
    ...
    return t.Ri = function(e, n, r, i) {
        // TODO(mcg): Figure out what constraints there are on userIDs
        // In particular, are there any reserved characters? are empty ids allowed?
        // For the moment store these together in the same mutations table assuming
        // that empty userIDs aren't allowed.
        return x$1("" !== e.uid), new t(e.A() ? e.uid : "", n, r, i);
        ...
        return u.add({}).next((function(s) {
            x$1("number" == typeof s);
            for (var a = new ti(s, e, n, r), c = function(t, e, n) {
                var r = n.baseMutations.map((function(e) {
                    return Zn(t.Ms, e);
                })), i = n.mutations.map((function(e) {
                    return Zn(t.Ms, e);
                }));
                return new Ur(e, n.batchId, n.Ds.toMillis(), r, i);
            }(i.Kt, i.userId, a), f = [], h = new hn((function(t, e) {
                return P$1(t.ot(), e.ot());
            })), l = 0, p = r; l < p.length; l++) {
                var d = p[l], v = qr.key(i.userId, d.key.path, s);
                h = h.add(d.key.path.Z()), f.push(u.put(c)), f.push(o.put(v, qr.PLACEHOLDER));
            }
        ...
        var n = this;
        return Di(t).get(e).next((function(t) {
            return t ? (x$1(t.userId === n.userId), ci(n.Kt, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Vi = function(t, e) {
        var n = this;
        return this.Ai[e] ? yr.resolve(this.Ai[e]) : this.gi(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Ai[e] = r, r;
            }
        ...
        return Di(t).ls({
            ...
            e.userId === n.userId && (x$1(e.batchId >= r), o = ci(n.Kt, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        var n = this, r = qr.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        ...
        // the given documentKey.
            ...
            return Di(t).get(c).next((function(t) {
                if (!t) throw S$1();
                x$1(t.userId === n.userId), o.push(ci(n.Kt, t));
            }));
            u.done();
        })).next((function() {
            return o;
        ...
        return e.forEach((function(e) {
            var o = qr.prefixForPath(n.userId, e.path), u = IDBKeyRange.lowerBound(o), s = ki(t).ls({
                range: u
            }, (function(t, i, o) {
        ...
        var n = this, r = e.path, i = r.length + 1, o = qr.prefixForPath(this.userId, r), u = IDBKeyRange.lowerBound(o), s = new hn(P$1);
        return ki(t).ls({
            range: u
        }, (function(t, e, o) {
        ...
        return e.forEach((function(e) {
            i.push(Di(t).get(e).next((function(t) {
                if (null === t) throw S$1();
                x$1(t.userId === n.userId), r.push(ci(n.Kt, t));
            })));
        })), yr.$n(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return Ni(t.vs, this.userId, e).next((function(r) {
            return t.ps((function() {
                n.Fi(e.batchId);
    ...
    t.prototype.Fi = function(t) {
        ...
        var e = this;
        return this.Pi(t).next((function(n) {
            if (!n) return yr.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(qr.prefixForUser(e.userId)), i = [];
            return ki(t).ls({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
 ...
 */ function xi(t, e, n) {
    var r = qr.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), u = !1;
    return ki(t).ls({
        range: o,
        hs: !0
    }, (function(t, n, r) {
 ...
 */ var Pi = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Qi(t).next((function(t) {
            return Z$1.W(new X$1(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        var n = this;
        return this.Hi(t, e).next((function() {
            return n.Qi(t).next((function(r) {
                return r.targetCount += 1, n.Ji(e, r), n.Ki(t, r);
            }));
        }));
        ...
        var n = this;
        return this.Zi(t, e.targetId).next((function() {
            return Li(t).delete(e.targetId);
        })).next((function() {
            return n.Qi(t);
        })).next((function(e) {
            return x$1(e.targetCount > 0), e.targetCount -= 1, n.Ki(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.tr = function(t, e, n) {
        ...
        return Li(t).ls((function(u, s) {
            var a = fi(s);
            a.sequenceNumber <= e && null === n.get(a.targetId) && (i++, o.push(r.Xi(t, a)));
        })).next((function() {
            return yr.$n(o);
        })).next((function() {
            return i;
    ...
    t.prototype.mn = function(t, e) {
        ...
        return Ri(t).get(Hr.key).next((function(t) {
            return x$1(null !== t), t;
        }));
    }, t.prototype.Ki = function(t, e) {
        return Ri(t).put(Hr.key, e);
    }, t.prototype.Hi = function(t, e) {
        return Li(t).put(hi(this.Kt, e));
    }, 
    /**
    ...
    t.prototype.Ji = function(t, e) {
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var u = Or(e.path);
            i.push(o.put(new Kr(n, u))), i.push(r.mi.ir(t, n, e));
        })), yr.$n(i);
        ...
        // IndexedDb.
            ...
            var o = Or(e.path);
            return yr.$n([ i.delete([ n, o ]), r.mi.cr(t, n, e) ]);
        }));
    }, t.prototype.Zi = function(t, e) {
        var n = Vi(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        var n = Or(e.path), r = IDBKeyRange.bound([ n ], [ L$1(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Vi(t).ls({
 ...
 */
function Li(t) {
    return Zr(t, Br.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function Ri(t) {
    return Zr(t, Hr.store);
}
 ...
 */ var Ui = /** @class */ function() {
    function t(t) {
        this.ur = t, this.buffer = new hn(Mi), this.hr = 0;
    }
    return t.prototype.lr = function() {
        return ++this.hr;
    }, t.prototype._r = function(t) {
        var e = [ t, this.lr() ];
        if (this.buffer.size < this.ur) this.buffer = this.buffer.add(e); else {
            var n = this.buffer.last();
            Mi(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
    ...
    return t.prototype.start = function(t) {
        ...
        E$1("LruGarbageCollector", "Garbage collection scheduled in " + n + "ms"), this.Er = this.fs.mr("lru_garbage_collection" /* LruGarbageCollection */ , n, (function() {
            return __awaiter(e, void 0, void 0, (function() {
                ...
                return __generator(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return n.trys.push([ 1, 3, , 7 ]), [ 4 /*yield*/ , t.Ar(this.dr) ];

                      case 2:
                        return n.sent(), [ 3 /*break*/ , 7 ];

                      case 3:
                        return Ir(e = n.sent()) ? (E$1("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.Pr = function(t, e) {
        ...
        var n = this;
        return -1 === this.params.Js ? (E$1("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        yr.resolve(bi)) : this.vr(t).next((function(r) {
            return r < n.params.Js ? (E$1("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.params.Js), 
            bi) : n.Sr(t, e);
        }));
        ...
        return this.Pr(t, this.params.Ys).next((function(e) {
            // Cap at the configured max
            return e > f.params.Xs ? (E$1("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + f.params.Xs + " from " + e), 
            i = f.params.Xs) : i = e, u = Date.now(), f.gr(t, i);
        })).next((function(e) {
            return r = e, s = Date.now(), f.tr(t, r, n);
        })).next((function(e) {
            return o = e, a = Date.now(), f.pr(t, r);
        })).next((function(t) {
            return c = Date.now(), _() <= LogLevel.DEBUG && E$1("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (u - h) + "ms\n\tDetermined least recently used " + i + " in " + (s - u) + "ms\n\tRemoved " + o + " targets in " + (a - s) + "ms\n\tRemoved " + t + " documents in " + (c - a) + "ms\nTotal Duration: " + (c - h) + "ms"), 
            yr.resolve({
                js: !0,
                Gs: i,
                zs: o,
    ...
    function t(t, e) {
        this.db = t, this.dr = function(t, e) {
            return new Fi(t, e);
        }(this, e);
    }
    return t.prototype.yr = function(t) {
        var e = this.Dr(t);
        return this.db.Cr().er(t).next((function(t) {
    ...
    t.prototype.Fr = function(t, e) {
        return function(t, e) {
            var n = !1;
            return Oi(t)._s((function(r) {
                return xi(t, r, e).next((function(t) {
        ...
        var n = this, r = this.db.kr().Or(), i = [], o = 0;
        return this.Nr(t, (function(u, s) {
            if (s <= e) {
                var a = n.Fr(t, u).next((function(e) {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return o++, r.di(t, u).next((function() {
                        return r.fi(u), Vi(t).delete([ 0, Or(u.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var Gi = /** @class */ function() {
    ...
    t.prototype.Qr = function(t, e) {
        ...
        return this.Ur(t, e, (function(t, e) {
            var o = n.Br(e);
            o ? (r = r.Ht(t, o), i = i.Ht(t, Ai(e))) : (r = r.Ht(t, null), i = i.Ht(t, 0));
        })).next((function() {
            return {
                Kr: r,
                Wr: i
        ...
        if (n.isEqual(Z$1.min())) {
            ...
            var a = e.path.rt(), c = oi(n);
            u.range = IDBKeyRange.lowerBound([ a, c ], 
            /* open= */ !0), u.index = zr.collectionReadTimeIndex;
        }
        return Hi(t).ls(u, (function(t, n, u) {
        ...
        return new Bi(this, !!t && t.Gr);
    }, t.prototype.Lr = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return Ki(t).get(Gr.key).next((function(t) {
            return x$1(!!t), t;
        }));
    }, t.prototype.$r = function(t, e) {
        return Ki(t).put(Gr.key, e);
    }, 
    /**
    ...
    t.prototype.Br = function(t) {
        if (t) {
            var e = ri(this.Kt, t);
            return e instanceof Mt && e.version.isEqual(Z$1.min()) ? null : e;
        }
        return null;
    }, t;
}(), Bi = /** @class */ function(t) {
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this) || this).zr = e, r.Gr = n, 
        // A map of document sizes prior to applying the changes in this buffer.
        r.Hr = new Ei((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
        })), r;
    ...
    return __extends$1(e, t), e.prototype.Ti = function(t) {
        ...
        return this.ci.forEach((function(o, u) {
            var s = e.Hr.get(o);
            if (u._i) {
                var a = ii(e.zr.Kt, u._i, e.ui(o));
                i = i.add(o.path.Z());
                var c = Ai(a);
                r += c - s, n.push(e.zr.hi(t, o, a));
            } else if (r -= s, e.Gr) {
                // In order to track removals, we store a "sentinel delete" in the
                // RemoteDocumentCache. This entry is represented by a NoDocument
                // with a version of 0 and ignored by `maybeDecodeDocument()` but
                // preserved in `getNewDocumentChanges()`.
                var f = ii(e.zr.Kt, new Mt(o, Z$1.min()), e.ui(o));
                n.push(e.zr.hi(t, o, f));
            } else n.push(e.zr.fi(t, o));
        })), i.forEach((function(r) {
            n.push(e.zr.Ii.Qs(t, r));
        })), n.push(this.zr.updateMetadata(t, r)), yr.$n(n);
    }, e.prototype.wi = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute a delta later.
                return this.zr.qr(t, e).next((function(t) {
            return null === t ? (n.Hr.set(e, 0), null) : (n.Hr.set(e, t.size), t._i);
        }));
        ...
        // a delta later.
            ...
            return t.Wr.forEach((function(t, e) {
                n.Hr.set(t, e);
            })), e;
        }));
    }, e;
 ...
 */ function Ki(t) {
    return Zr(t, Gr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Hi(t) {
    return Zr(t, zr.store);
}
...
/** Performs database creation and schema upgrades. */ var Wi = /** @class */ function() {
     ...
     */    return t.prototype.Yn = function(t, e, n, r) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Kr.store), t.deleteObjectStore(Br.store), t.deleteObjectStore(Hr.store);
     ...
     */
        ...
        var e = 0;
        return t.store(zr.store).ls((function(t, n) {
            e += Ai(n);
        })).next((function() {
            var n = new Gr(e);
        ...
        var e = this, n = t.store(Mr.store), r = t.store(Ur.store);
    ...
    t.prototype.Xr = function(t) {
        var e = t.store(Kr.store), n = t.store(zr.store);
            ...
            return n.ls((function(n, i) {
                ...
                r.push(e.get(u).next((function(n) {
                    return n ? yr.resolve() : function(n) {
                        return e.put(new Kr(0, Or(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return yr.$n(r);
        ...
        var n = e.store(Jr.store), r = new mi, i = function(t) {
            if (r.add(t)) {
                var e = t.et(), i = t.Z();
                return n.put({
                    collectionId: e,
        ...
        // Index existing remote documents.
                return e.store(zr.store).ls({
            hs: !0
        }, (function(t, e) {
            var n = new et(t);
            return i(n.Z());
        })).next((function() {
            return e.store(qr.store).ls({
                hs: !0
            }, (function(t, e) {
                t[0];
...
var Yi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", $i = /** @class */ function() {
    function t(
    /**
    ...
    f) {
        ...
        this.no = o, this.window = u, this.document = s, this.so = c, this.io = f, this.ro = null, 
        this.oo = !1, this.isPrimary = !1, this.networkEnabled = !0, 
        /** Our window.unload handler, if registered. */
        this.co = null, this.inForeground = !1, 
        ...
        }, !t.Wn()) throw new M$1(V$1.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.mi = new ji(this, i), this._o = n + "main", this.Kt = new ni(a), this.fo = new gr(this._o, 11, new Wi(this.Kt)), 
        this.wo = new Ci(this.mi, this.Kt), this.Ii = new gi, this.Eo = function(t, e) {
            return new Gi(t, e);
        }(this.Kt, this.Ii), this.To = new pi, this.window && this.window.localStorage ? this.Io = this.window.localStorage : (this.Io = null, 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
                return this.mo().then((function() {
            if (!t.isPrimary && !t.allowTabSynchronization) 
            // Fail `start()` if `synchronizeTabs` is disabled and we cannot
            // obtain the primary lease.
            throw new M$1(V$1.FAILED_PRECONDITION, Yi);
            return t.Ao(), t.Ro(), t.Po(), t.runTransaction("getHighestListenSequenceNumber", "readonly", (function(e) {
                return t.wo.ji(e);
            }));
        })).then((function(e) {
            t.ro = new $(e, t.so);
    ...
    t.prototype.mo = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Zi(e).put(new Wr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
                if (t.isPrimary) return t.bo(e).next((function(e) {
                    e || (t.isPrimary = !1, t.no.vo((function() {
                        return t.lo(!1);
                    })));
                }));
            })).next((function() {
                ...
                return t.isPrimary && !n ? t.Do(e).next((function() {
                    return !1;
                })) : !!n && t.Co(e).next((function() {
                    return !0;
                }));
            }));
        })).catch((function(e) {
            ...
            t.isPrimary !== e && t.no.vo((function() {
                return t.lo(e);
            })), t.isPrimary = e;
        }));
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        ...
                        return e.os().next((function(t) {
                            var n = i.ko(t, 18e5), r = t.filter((function(t) {
                  ...
                  case 1:
                    ...
                    if (t = o.sent(), this.Io) for (e = 0, n = t; e < n.length; e++) r = n[e], this.Io.removeItem(this.Mo(r.clientId));
                    o.label = 2;
    ...
    t.prototype.Po = function() {
        var t = this;
        this.uo = this.no.mr("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (function() {
            return t.mo().then((function() {
                return t.Fo();
            })).then((function() {
                return t.Po();
            }));
    ...
    /** Checks whether `client` is the local client. */ t.prototype.xo = function(t) {
    ...
    t.prototype.So = function(t) {
        var e = this;
        return this.io ? yr.resolve(!0) : Xi(t).get(Vr.key).next((function(n) {
            ...
            if (null !== n && e.Oo(n.leaseTimestampMs, 5e3) && !e.Lo(n.ownerId)) {
                if (e.xo(n) && e.networkEnabled) return !0;
                if (!e.xo(n)) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Zi(t).os().next((function(t) {
                return void 0 === e.ko(t, 5e3).find((function(t) {
            ...
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.oo = !1, this.Bo(), this.uo && (this.uo.cancel(), this.uo = null), this.qo(), 
                    this.Uo(), [ 4 /*yield*/ , this.fo.runTransaction("shutdown", "readwrite", [ Vr.store, Wr.store ], (function(e) {
                        var n = new Xr(e, $.U);
                        return t.Do(n).next((function() {
                            return t.No(n);
                        }));
                    })) ];
    ...
    t.prototype.Ko = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Zi(e).os().next((function(e) {
                return t.ko(e, 18e5).map((function(t) {
                    return t.clientId;
                }));
            }));
        }));
        ...
        return Si.Ri(t, this.Kt, this.Ii, this.mi);
        ...
        return this.fo.runTransaction(t, o, $r, (function(o) {
            return i = new Xr(o, r.ro ? r.ro.next() : $.U), "readwrite-primary" === e ? r.bo(i).next((function(t) {
                return !!t || r.So(i);
            })).next((function(e) {
                if (!e) throw T$1("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.no.vo((function() {
                    return r.lo(!1);
                })), new M$1(V$1.FAILED_PRECONDITION, Dr);
                return n(i);
            })).next((function(t) {
                return r.Co(i).next((function() {
                    return t;
                }));
            })) : r.zo(i).next((function() {
                return n(i);
            }));
        })).then((function(t) {
            return i.bs(), t;
    ...
    t.prototype.zo = function(t) {
        var e = this;
        return Xi(t).get(Vr.key).next((function(t) {
            if (null !== t && e.Oo(t.leaseTimestampMs, 5e3) && !e.Lo(t.ownerId) && !e.xo(t) && !(e.io || e.allowTabSynchronization && t.allowTabSynchronization)) throw new M$1(V$1.FAILED_PRECONDITION, Yi);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Do = function(t) {
        var e = this, n = Xi(t);
        return n.get(Vr.key).next((function(t) {
            return e.xo(t) ? (E$1("IndexedDbPersistence", "Releasing primary lease."), n.delete(Vr.key)) : yr.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.Oo = function(t, e) {
        ...
        var t = this;
        null !== this.document && "function" == typeof this.document.addEventListener && (this.ao = function() {
            t.no.ys((function() {
                return t.inForeground = "visible" === t.document.visibilityState, t.mo();
            }));
        }, this.document.addEventListener("visibilitychange", this.ao), this.inForeground = "visible" === this.document.visibilityState);
    }, t.prototype.qo = function() {
        this.ao && (this.document.removeEventListener("visibilitychange", this.ao), this.ao = null);
    }, 
    /**
    ...
    t.prototype.Ro = function() {
        var t, e = this;
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.co = function() {
            // Note: In theory, this should be scheduled on the AsyncQueue since it
            // accesses internal state. We execute this code directly during shutdown
            // to make sure it gets a chance to run.
            e.Bo(), e.no.ys((function() {
                return e.$o();
            }));
        }, this.window.addEventListener("unload", this.co));
    }, t.prototype.Uo = function() {
        this.co && (this.window.removeEventListener("unload", this.co), this.co = null);
    }, 
    /**
    ...
    t.prototype.Lo = function(t) {
        var e;
        try {
            var n = null !== (null === (e = this.Io) || void 0 === e ? void 0 : e.getItem(this.Mo(t)));
 ...
 */
function Xi(t) {
    return Zr(t, Vr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function Zi(t) {
    return Zr(t, Wr.store);
}
...
var eo = /** @class */ function() {
    ...
    /** Internal version of `getDocument` that allows reusing batches. */ t.prototype.Yo = function(t, e, n) {
        return this.Eo.di(t, e).next((function(t) {
            for (var r = 0, i = n; r < i.length; r++) {
                t = i[r].Ns(e, t);
            }
            return t;
    ...
    t.prototype.Zo = function(t, e) {
        var n = this;
        return this.Eo.getEntries(t, e).next((function(e) {
            return n.tc(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.tc = function(t, e) {
        var n = this;
        return this.Ho.Di(t, e).next((function(r) {
            var i = n.Xo(t, e, r), o = dn();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new Mt(t, Z$1.min())), o = o.Ht(t, e);
            })), o;
        }));
    }, 
    /**
 ...
 */
        ...
        return this.Ii.Ks(t, i).next((function(u) {
        ...
        // Query the remote documents and overlay mutations.
                return this.Eo.jr(t, e, n).next((function(n) {
            return r = n, o.Ho.xi(t, e);
        })).next((function(e) {
            return i = e, o.ic(t, i, r).next((function(t) {
                r = t;
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], u = 0, s = o.mutations; u < s.length; u++) {
                    var a = s[u], c = a.key, f = r.get(c), h = Be(a, f, f, o.Ds);
                    r = h instanceof Vt ? r.Ht(c, h) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        for (var r = In(), i = 0, o = e; i < o.length; i++) for (var u = 0, s = o[i].mutations; u < s.length; u++) {
            var a = s[u];
    ...
    return t.cc = function(e, n) {
        for (var r = In(), i = In(), o = 0, u = n.docChanges; o < u.length; o++) {
            var s = u[o];
            switch (s.type) {
              case 0 /* Added */ :
                r = r.add(s.doc.key);
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.jr = function(t, n, r, i) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = o.lc(n, u);
            return (ae(n) || ce(n)) && o._c(n.limitType, s, i, r) ? o.hc(t, n) : (_() <= LogLevel.DEBUG && E$1("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), ge(n)), 
    ...
    t.prototype._c = function(t, e, n, r) {
        ...
        return _() <= LogLevel.DEBUG && E$1("QueryEngine", "Using full collection scan to execute query:", ge(n)), 
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.Ec = Z$1.min(), this.Ho = t.Wo(n), this.Tc = t.kr(), this.wo = t.Cr(), this.Ic = new eo(this.Tc, this.Ho, this.persistence.jo()), 
        this.To = t.Go(), this.fc.ac(this.Ic);
    }
...
function uo(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              case 0:
                return n = D$1(t), r = n.Ho, i = n.Ic, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    // Swap out the mutation queue, grabbing the pending mutation batches
                    // before and after.
                    var o;
                    return n.Ho.vi(t).next((function(u) {
                        return o = u, r = n.persistence.Wo(e), 
                        // Recreate our LocalDocumentsView using the new
                        // MutationQueue.
                        i = new eo(n.Tc, r, n.persistence.jo()), r.vi(t);
                    })).next((function(e) {
                        for (var n = [], r = [], u = In(), s = 0, a = o
        ...
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                u = u.next((function() {
                    ...
                    var o = e, u = n.ks.get(t);
                    x$1(null !== u), (!o || o.version.u(u) < 0) && ((o = i.Cs(t, o, n)) && 
 ...
 */ function co(t, e) {
    ...
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        ...
        e.Oe.forEach((function(e, o) {
            ...
            if (s) {
                ...
                u.push(n.wo.rr(t, e.Ke, o).next((function() {
                    return n.wo.sr(t, e.Ue, o);
                })));
                var a = e.resumeToken;
                // Update the resume token if the change includes one.
                                if (a.o() > 0) {
                    var c = s.$t(a, r).Lt(t.Ss);
                    i = i.Ht(o, c), 
     ...
     */
        ...
        // limbo.
            ...
            e.Le.has(r) && u.push(n.persistence.mi.Mr(t, r));
        })), 
        ...
        u.push(fo(t, o, e.Me, r, void 0).next((function(t) {
            ...
            var a = n.wo.Wi(t).next((function(e) {
                return n.wo.Gi(t, t.Ss, r);
            }));
            u.push(a);
        }
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, u) {
            ...
            // cache.
                        u instanceof Mt && u.version.isEqual(Z$1.min()) ? (
            // NoDocuments with SnapshotVersion.min() are used in manufactured
            // events. We remove these documents from cache since we lost
            // access.
            e.fi(n, a), o = o.Ht(n, u)) : null == s || u.version.u(s.version) > 0 || 0 === u.version.u(s.version) && s.hasPendingWrites ? (e.hi(u, a), 
...
function ho(t, e) {
    ...
    return n.persistence.runTransaction("Get next mutation batch", "readonly", (function(t) {
        return void 0 === e && (e = -1), n.Ho.pi(t, e);
    }));
}
 ...
 */ function lo(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        var r;
        return n.wo.nr(t, e).next((function(i) {
            return i ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            r = i, yr.resolve(r)) : n.wo.Ui(t).next((function(i) {
                return r = new _e(e, i, 0 /* Listen */ , t.Ss), n.wo.zi(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function po(t, e, n) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(s) {
            switch (s.label) {
              case 0:
                r = D$1(t), i = r.dc.get(e), o = n ? "readwrite" : "readwrite-primary", s.label = 1;

              case 1:
                return s.trys.push([ 1, 4, , 5 ]), n ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , r.persistence.runTransaction("Release target", o, (function(t) {
                    return r.persistence.mi.removeTarget(t, i);
                })) ];
 ...
 */ function vo(t, e, n) {
    var r = D$1(t), i = Z$1.min(), o = In();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = D$1(t), i = r.wc.get(n);
            return void 0 !== i ? yr.resolve(r.dc.get(i)) : r.wo.nr(e, n);
        }(r, t, de(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.wo.ar(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.fc.jr(t, e, n ? i : Z$1.min(), n ? o : In());
        })).next((function(t) {
            return {
                documents: t,
                Pc: o
...
// PORTING NOTE: Multi-Tab only.
function yo(t, e) {
    var n = D$1(t), r = D$1(n.wo), i = n.dc.get(e);
...
function mo(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = D$1(t), i = dn(), o = oi(n), u = Hi(e), s = IDBKeyRange.lowerBound(o, !0);
            return u.ls({
 ...
 */ var Io = /** @class */ function() {
    ...
    /** Adds a reference to the given document key for the given ID. */ t.prototype.ir = function(t, e) {
        var n = new Eo(t, e);
    ...
    t.prototype.kc = function(t) {
        ...
        var e = new it(new et([])), n = new Eo(e, t), r = new Eo(e, t + 1), i = In();
    ...
    return t.prototype.Pi = function(t) {
        ...
        for (var u = 0, s = r; u < s.length; u++) {
            var a = s[u];
            this.qc = this.qc.add(new Eo(a.key, i)), this.Ii.Qs(t, a.key.path.Z());
        }
        return yr.resolve(o);
    }, t.prototype.gi = function(t, e) {
        ...
        var n = this;
        x$1(0 === this.Wc(e.batchId, "removed")), this.Ho.shift();
        var r = this.qc;
        return yr.forEach(e.mutations, (function(i) {
            var o = new Eo(i.key, e.batchId);
            return r = r.delete(o), n.mi.Oi(t, i.key);
        })).next((function() {
            n.qc = r;
        }));
    }, t.prototype.Fi = function(t) {
    ...
    return t.prototype.hi = function(t, e, n) {
        ...
        return this.docs = this.docs.Ht(r, {
            ...
            size: u,
            readTime: n
        }), this.size += u - o, this.Ii.Qs(t, r.path.Z());
    }, 
    /**
    ...
    t.prototype.fi = function(t) {
        ...
        ; o.ae(); ) {
            var u = o.ce(), s = u.key, a = u.value, c = a._i, f = a.readTime;
...
}(Ti), So = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.zc = new Ei((function(t) {
            return jt(t);
        }), zt), 
        ...
        /**
             ...
             * IDs.
             */
        this.Jc = new _o, this.targetCount = 0, this.Yc = Pi.Bi();
    }
    return t.prototype.mn = function(t, e) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Yc = new Pi(e), this.highestTargetId = e), t.sequenceNumber > this.Hc && (this.Hc = t.sequenceNumber);
    }, t.prototype.zi = function(t, e) {
        return this.Hi(e), this.targetCount += 1, yr.resolve();
    }, t.prototype.Yi = function(t, e) {
        return this.Hi(e), yr.resolve();
    }, t.prototype.Xi = function(t, e) {
        ...
        return this.zc.forEach((function(u, s) {
            s.sequenceNumber <= e && null === n.get(s.targetId) && (r.zc.delete(u), o.push(r.Zi(t, s.targetId)), 
            i++);
        ...
        return yr.resolve(this.Jc.Mi(e));
    }, t;
}(), xo = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.Xc = {}, this.ro = new $(0), this.oo = !1, this.oo = !0, this.mi = t(this), 
        this.wo = new So(this), this.Ii = new yi, this.Eo = function(t, e) {
            return new No(t, (function(t) {
                return n.mi.Zc(t);
            }));
        }(this.Ii), this.Kt = new ni(e), this.To = new Io(this.Kt);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.$o = function() {
        ...
        var e = this.Xc[t.R()];
        return e || (e = new To(this.Ii, this.mi), this.Xc[t.R()] = e), e;
    }, t.prototype.Cr = function() {
        return this.wo;
    }, t.prototype.kr = function() {
        return this.Eo;
        ...
        var i = new Do(this.ro.next());
        return this.mi.ta(), n(i).next((function(t) {
    ...
    return t.ra = function(e) {
        ...
        return this.sa.ir(n, e), this.oa.delete(n.toString()), yr.resolve();
    }, t.prototype.cr = function(t, e, n) {
        return this.sa.cr(n, e), this.oa.add(n.toString()), yr.resolve();
    }, t.prototype.Oi = function(t, e) {
        ...
        return r.ar(t, e.targetId).next((function(t) {
            t.forEach((function(t) {
                return n.oa.add(t.toString());
            }));
        })).next((function() {
        ...
        var e = this, n = this.persistence.kr().Or();
...
var Lo = /** @class */ function() {
    ...
    return t.aa = function(e, n, r) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (u = new M$1(i.error.code, i.error.message))), 
    ...
    return t.aa = function(e, n) {
        ...
        return i && r.error && ((i = "string" == typeof r.error.message && "string" == typeof r.error.code) && (o = new M$1(r.error.code, r.error.message))), 
    ...
    function t(t, e, n, r, i) {
        this.window = t, this.no = e, this.persistenceKey = n, this._a = r, this.fa = null, 
        ...
        }(this.persistenceKey), this.Ta = this.Ta.Ht(this._a, new Uo), this.Ra = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.Wn = function(t) {
        ...
        this.Ir && (this.window.removeEventListener("storage", this.wa), this.removeItem(this.ma), 
        this.Ir = !1);
                    ...
                    return __generator(this, (function(s) {
                        if (this.Ir) {
                            if (null !== n.key) if (this.Ra.test(n.key)) {
                                ...
                                return e;
                            }(n.newValue)) !== $.U && this.L(u); else if (n.key === this.Va) return [ 2 /*return*/ , this.fa.eu() ];
                        } else this.Ia.push(n);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new Lo(this.currentUser, t, e, n), i = Po(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.ua());
        ...
        var r = Co(this.persistenceKey, t), i = new Ro(t, e, n);
        this.setItem(r, i.ua());
    ...
    function t() {
        this.ru = new Uo, this.ou = {}, this.da = null, this.L = null;
    }
    return t.prototype.xa = function(t) {
        ...
        // No op.
    }, t.prototype.$o = function() {}, t.prototype.q = function(t) {}, t.prototype.ja = function() {
        // No op.
    }, t;
}(), jo = /** @class */ function() {
    function t() {}
    ...
    return __extends$1(e, t), e.prototype.Du = function(t, e, n, r) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case ErrorCode.TIMEOUT:
                        E$1("Connection", 'RPC "' + t + '" timed out'), o(new M$1(V$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case ErrorCode.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new M$1(s, r.message));
                            } else o(new M$1(V$1.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new M$1(V$1.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var g = c.createWebChannel(m, h), w = !1, b = !1, I = new Bo({
            du: function(t) {
        ...
        return _(g, WebChannel.EventType.OPEN, (function() {
            ...
            b || (b = !0, E$1("Connection", "WebChannel transport closed"), I.Pu());
        })), _(g, WebChannel.EventType.ERROR, (function(t) {
            b || (b = !0, N$1("Connection", "WebChannel transport errored:", t), I.Pu(new M$1(V$1.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    b = !0, I.Pu(new M$1(u, s)), g.close();
                } else E$1("Connection", "WebChannel received:", n), I.yu(n);
            }
        })), _(f, Event.STAT_EVENT, (function(t) {
    ...
    t.prototype.Su = function(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/8.2.1", 
 ...
 */ var Qo = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.no = t, this.ds = e, this.Nu = n, this.Fu = r, this.Ou = i, this.ku = 0, this.Mu = null, 
    ...
    function t(t, e, n, r, i, o) {
        this.no = t, this.Qu = n, this.Ku = r, this.Wu = i, this.listener = o, this.state = 0 /* Initial */ , 
        /**
    ...
    t.prototype.Zu = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.Ju() && null === this.Gu && (this.Gu = this.no.mr(this.Qu, 6e4, (function() {
            return t.th();
        })));
    }, 
    ...
    t.prototype.sh = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new M$1(V$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.oh(e);
            }));
        }));
    ...
    t.prototype.ih = function(t) {
        ...
        return function(n) {
            e.no.ys((function() {
                return e.ju === t ? n() : (E$1("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.qt ? (x$1(void 0 === e || "string" == typeof e), R$1.fromBase64String(e || "")) : (x$1(void 0 === e || e instanceof Uint8Array), 
                ...
                n = new Dn(a, c, u.key, u);
            } else if ("documentDelete" in e) e.documentDelete, (r = e.documentDelete).document, 
            i = Hn(t, r.document), o = r.readTime ? zn(r.readTime) : Z$1.min(), s = new Mt(i, o), 
            u = r.removedTargetIds || [], n = new Dn([], u, s.key, s); else if ("documentRemove" in e) e.documentRemove, 
            (r = e.documentRemove).document, i = Hn(t, r.document), o = r.removedTargetIds || [], 
            n = new Dn([], o, i, null); else {
                if (!("filter" in e)) return S$1();
                e.filter;
                var f = e.filter;
                f.targetId, r = f.count || 0, i = new on$1(r), o = f.targetId, n = new kn(o, i);
            }
            return n;
    ...
    e.prototype.hh = function(t) {
        ...
        e.database = Qn(this.Kt), e.addTarget = function(t, e) {
            ...
            return (n = Gt(r) ? {
                ...
                query: nr(t, r)
            }).targetId = e.targetId, e.resumeToken.o() > 0 ? n.resumeToken = Fn(t, e.resumeToken) : e.Mt.u(Z$1.min()) > 0 && (
    ...
    e.prototype.start = function() {
        ...
        x$1(!!t.streamToken), this.lastStreamToken = t.streamToken, this._h) {
        ...
        // The first response is always the handshake response
                return x$1(!t.writeResults || 0 === t.writeResults.length), this._h = !0, 
        this.listener.Eh();
    }, 
    /**
    ...
    return __extends$1(e, t), e.prototype.mh = function() {
        if (this.Ih) throw new M$1(V$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    return t.prototype.yh = function() {
        var t = this;
        0 === this.Ah && (this.gh("Unknown" /* Unknown */), this.Rh = this.fs.mr("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return __awaiter(this, void 0, void 0, (function() {
                                ...
                                return __generator(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = D$1(t)).Fh.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , ru(e) ];
    ...
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              ...
              case 6:
                if (e instanceof Dn ? t.Lh.wn(e) : e instanceof kn ? t.Lh.yn(e) : t.Lh.In(e), n.isEqual(Z$1.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;
                ...
                function(t, e) {
                    ...
                    n.ke.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            var r = new _e(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            uu(t, r);
                        }
                    })), t.Ch.Bh(n);
                }(t, n) ] : [ 3 /*break*/ , 10 ];
        ...
        return __generator(this, (function(i) {
            switch (i.label) {
              case 0:
                ...
                return t.Fh.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , ru(t) ];
                    ...
                    return __awaiter(r, void 0, void 0, (function() {
                        return __generator(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Fh.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , nu(t) ];
...
function mu(t) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(u) {
            switch (u.label) {
              case 0:
                e = D$1(t), n = Au(e), r = e.xh.length > 0 ? e.xh[e.xh.length - 1].batchId : -1, u.label = 1;
 ...
 */ function Tu(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(i) {
            switch (i.label) {
              case 0:
                return n = D$1(t), e ? (n.Fh.delete(2 /* IsSecondary */), [ 4 /*yield*/ , nu(n) ]) : [ 3 /*break*/ , 2 ];
...
var Su = function() {
    ...
    this.queries = new Ei((function(t) {
        return me(t);
    }), ye), this.onlineState = "Unknown" /* Unknown */ , this.jh = new Set;
};
...
function Du(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = D$1(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new Su), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
              ...
              case 4:
                ...
                e.zh(n.onlineState), o.Wh && e.Hh(o.Wh) && Cu(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function ku(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        var n, r, i, o, u;
        return __generator(this, (function(s) {
            return n = D$1(t), r = e.query, i = !1, (o = n.queries.get(r)) && (u = o.listeners.indexOf(e)) >= 0 && (o.listeners.splice(u, 1), 
 ...
 */ var qu = function(t) {
    ...
    e) {
        ...
        this.Ce = In(), this.ll = be(t), this._l = new Tn(this.ll);
    }
    ...
    t.prototype.Tl = function(t) {
        ...
        // updating many documents.
                var e = this.hl;
        this.hl = In(), this._l.forEach((function(e) {
    ...
    t.prototype.Rl = function(t) {
        this.al = t.Pc, this.hl = In();
        var e = this.dl(t.documents);
        return this.Ti(e, /*updateLimboDocuments=*/ !0);
    }, 
    /**
    ...
    t.prototype.Pl = function() {
        return An.Fe(this.query, this._l, this.Ce, 0 /* Local */ === this.ul);
    }, t;
}(), zu = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.vl = {}, this.Sl = new Ei((function(t) {
            return me(t);
        }), ye), this.Dl = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Nl = new Map, this.Fl = new _o, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Ol = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.kl = new Map, this.Ml = Pi.qi(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(f) {
            switch (f.label) {
                        ...
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(s) {
                                switch (s.label) {
                                  ...
                                  case 2:
                                    return o = r && r.Oe.get(e.targetId), u = e.view.Ti(i, 
              ...
              case 1:
                return i = f.sent(), o = new ju(e, i.Pc), u = o.dl(i.documents), s = xn.Be(n, r && "Offline" /* Offline */ !== t.onlineState), 
                a = o.Ti(u, 
...
/** Stops listening to the query. */ function Ju(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(o) {
            switch (o.label) {
              case 0:
                return n = D$1(t), r = n.Sl.get(e), (i = n.Dl.get(r.targetId)).length > 1 ? [ 2 /*return*/ , (n.Dl.set(r.targetId, i.filter((function(t) {
                    return !ye(t, e);
            ...
            switch (s.label) {
              ...
              case 1:
                return s.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = D$1(t), i = X$1.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), In());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Ic.Zo(t, o).next((function(o) {
                            ...
                            var u = [], s = 0, a = e; s < a.length; s++) {
                                ...
                                // exists=true
                                u.push(new Qe(c.key, f, Lt(f.proto.mapValue), Fe.exists(!0)));
                            }
                            return r.Ho.yi(t, i, u, e);
                        }));
                    })).then((function(t) {
                        var e = t.Fs(n);
                        return {
              ...
              case 2:
                return i = s.sent(), r.pl.xa(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new an(P$1)), r = r.Ht(e, n), t.Ol[t.currentUser.R()] = r;
                }(r, i.batchId, n), [ 4 /*yield*/ , as(r, i.ci) ];
            ...
            switch (i.label) {
              ...
              case 2:
                ...
                e.Oe.forEach((function(t, e) {
                    ...
                    x$1(t.Ue.size + t.Qe.size + t.Ke.size <= 1), t.Ue.size > 0 ? r.yl = !0 : t.Qe.size > 0 ? x$1(r.yl) : t.Ke.size > 0 && (x$1(r.yl), 
                    r.yl = !1));
                })), [ 4 /*yield*/ , as(n, r, e) ];
    ...
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(c) {
            switch (c.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (r = D$1(t)).pl.qa(e, "rejected", n), i = r.Nl.get(e), (o = i && i.key) ? (u = (u = new an(it.J)).Ht(o, new Mt(o, Z$1.min())), 
                s = In().add(o), a = new Sn(Z$1.min(), 
...
function Xu(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(o) {
            switch (o.label) {
              case 0:
                n = D$1(t), r = e.batch.batchId, o.label = 1;
              ...
              case 2:
                ...
                ns(n, r, /*error=*/ null), es(n, r), n.pl.Fa(r, "acknowledged"), [ 4 /*yield*/ , as(n, i) ];
        ...
        return __generator(this, (function(o) {
            switch (o.label) {
              ...
              case 1:
                return o.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        var r;
                        return n.Ho.gi(t, e).next((function(e) {
                            return x$1(null !== e), r = e.keys(), n.Ho.Ni(t, e);
                        })).next((function() {
                            return n.Ho.ki(t);
                        })).next((function() {
                            return n.Ic.Zo(t, r);
              ...
              case 2:
                ...
                // listen events.
                ns(r, e, n), es(r, e), r.pl.Fa(e, "rejected", n), [ 4 /*yield*/ , as(r, i) ];
 ...
 */ function ts(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(s) {
            switch (s.label) {
              case 0:
                fu((n = D$1(t)).gl) || E$1("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                s.label = 1;
...
function ns(t, e, n) {
    var r = D$1(t), i = r.Ol[r.currentUser.R()];
...
function os(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof qu ? (t.Fl.ir(o.key, e), us(t, o)) : o instanceof Fu ? (E$1("SyncEngine", "Document no longer in limbo: " + o.key), 
        t.Fl.cr(o.key, e), t.Fl.Mi(o.key) || 
        // We removed the last reference for this key
        is(t, o.key)) : S$1();
    }
}
 ...
 */ function ss(t) {
    for (;t.Cl.length > 0 && t.xl.size < t.bl; ) {
        ...
        t.Nl.set(n, new Gu(e)), t.xl = t.xl.Ht(e, n), iu(t.gl, new _e(de(se(e.path)), n, 2 /* LimboResolution */ , $.U));
    }
}
...
function as(t, e, n) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(s) {
            switch (s.label) {
              case 0:
                return r = D$1(t), i = [], o = [], u = [], r.Sl.nt() ? [ 3 /*break*/ , 3 ] : (r.Sl.forEach((function(t, s) {
                                ...
                                return h.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return yr.forEach(e, (function(e) {
                                        return yr.forEach(e.rc, (function(r) {
                                            return n.persistence.mi.ir(t, e.targetId, r);
                                        })).next((function() {
                                            return yr.forEach(e.oc, (function(r) {
                                                return n.persistence.mi.cr(t, e.targetId, r);
                                            }));
                                        }));
                                    }));
                                })) ];
...
function cs(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(i) {
            switch (i.label) {
              case 0:
                return (n = D$1(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (E$1("SyncEngine", "User change. New user:", e.R()), 
                [ 4 /*yield*/ , uo(n.Sh, e) ]);
              ...
              case 1:
                ...
                function(t, e) {
                    t.kl.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new M$1(V$1.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.kl.clear();
                }(n), 
...
function fs(t, e) {
    var n = D$1(t), r = n.Nl.get(e);
    if (r && r.yl) return In().add(r.key);
    var i = In(), o = n.Dl.get(e);
    if (!o) return i;
 ...
 */ function hs(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(o) {
            switch (o.label) {
              case 0:
                return [ 4 /*yield*/ , vo((n = D$1(t)).Sh, e.query, 
                /* usePreviousResults= */ !0) ];
...
function ls(t) {
    return __awaiter(this, void 0, void 0, (function() {
        var e;
        return __generator(this, (function(n) {
            return [ 2 /*return*/ , mo((e = D$1(t)).Sh).then((function(t) {
                return as(e, t);
            })) ];
        }));
    }));
            ...
            switch (u.label) {
              case 0:
                return [ 4 /*yield*/ , function(t, e) {
                    var n = D$1(t), r = D$1(n.Ho);
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Vi(t, e).next((function(e) {
...
function ds(t, e) {
    return __awaiter(this, void 0, void 0, (function() {
        ...
        return __generator(this, (function(f) {
            switch (f.label) {
              case 0:
                return bs(n = D$1(t)), Is(n), !0 !== e || !0 === n.Ll ? [ 3 /*break*/ , 3 ] : (r = n.pl.Sa(), 
                [ 4 /*yield*/ , vs(n, r.rt()) ]);
...
function ms(t) {
    var e = D$1(t);
    return D$1(D$1(e.Sh).persistence).Ko();
}
...
function bs(t) {
    var e = D$1(t);
    return e.gl.Ch.Bh = Qu.bind(null, e), e.gl.Ch.Sn = fs.bind(null, e), e.gl.Ch.$h = $u.bind(null, e), 
    e.vl.uh = Ou.bind(null, e.Vl), e.vl.ql = Pu.bind(null, e.Vl), e;
}

function Is(t) {
    var e = D$1(t);
    return e.gl.Ch.qh = Xu.bind(null, e), e.gl.Ch.Uh = Zu.bind(null, e), e
    /**
...
var Es = /** @class */ function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.sent(), [ 4 /*yield*/ , this.persistence.$o() ];
    ...
    return __extends$1(e, t), e.prototype.initialize = function(e) {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    return n.sent(), [ 4 /*yield*/ , Is(this.Xl.fa) ];
        ...
        var e = to(t.gu.T, t.gu.persistenceKey), n = void 0 !== this.cacheSizeBytes ? Ii.Zs(this.cacheSizeBytes) : Ii.ni;
        return new $i(this.synchronizeTabs, e, t.clientId, n, t.fs, Ho(), Jo(), this.Kt, this.pl, !!this.forceOwnership);
    }, e.prototype.jl = function(t) {
        return new Fo;
    }, e;
    ...
    return __extends$1(e, t), e.prototype.initialize = function(e) {
                        ...
                        return __awaiter(r, void 0, void 0, (function() {
                            return __generator(this, (function(e) {
                                switch (e.label) {
                                  ...
                                  case 1:
                                    return e.sent(), this.zl && (t && !this.zl.Ir ? this.zl.start(this.Sh) : t || this.zl.stop()), 
                                    [ 2 /*return*/ ];
                                }
                            }));
                        }));
        ...
        var e = Ho();
        if (!qo.Wn(e)) throw new M$1(V$1.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = to(t.gu.T, t.gu.persistenceKey);
        ...
        return function(t) {
            return __awaiter(this, void 0, void 0, (function() {
                ...
                return __generator(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = D$1(t), E$1("RemoteStore", "RemoteStore shutting down."), e.Fh.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , ru(e) ];

                      case 1:
                        return n.sent(), e.kh.$o(), 
 ...
 */ var xs = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.d_ = new rt(t);
    }
    /**
 ...
 */
function Ps(t, e, n) {
    if (!n) throw new M$1(V$1.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
...
function Cs(t, e) {
    ...
    if (void 0 !== e.mergeFields && void 0 !== e.merge) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
 ...
 */ function Ls(t, e, n, r) {
    if (!0 === e && !0 === r) throw new M$1(V$1.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function Rs(t) {
    if (!it.Et(t)) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function Vs(t) {
    if (it.Et(t)) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new M$1(V$1.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = Ms(t);
        throw new M$1(V$1.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function qs(t, e) {
    if (e <= 0) throw new M$1(V$1.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var Fs = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new M$1(V$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new M$1(V$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
...
}(), js = new Map, zs = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this.w_ = "(lite)", this.E_ = new Fs({}), this.T_ = !1, t instanceof B ? (this.I_ = t, 
        this.m_ = new J$1) : (this.A_ = t, this.I_ = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new M$1(V$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this.A_) throw new M$1(V$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.A_;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this.T_) throw new M$1(V$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this.E_ = new Fs(t), void 0 !== t.credentials && (this.m_ = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new M$1(V$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = js.get(t)) && (E$1("ComponentProvider", "Removing Datastore"), 
        js.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}(), Gs = /** @class */ function() {
    /** @hideconstructor */
 ...
 */ function Hs(t, e) {
    ...
    if (!(t instanceof Gs || t instanceof Ks)) throw new M$1(V$1.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
...
var Ys = /** @class */ function() {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new M$1(V$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new M$1(V$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.x_ = t, this.N_ = e;
    }
...
/** A "context" object passed around while parsing user data. */ var ea$1 = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.M_ = function(e) {
        ...
        return Ia$1(t, this.settings.methodName, this.settings.W_ || !1, this.path, this.settings.j_);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (ta$1(this.k_) && $s.test(t)) throw this.K_('Document fields cannot begin and end with "__"');
    }, t;
}(), na$1 = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse document data from a set() call. */ function ia(t, e, n, r, i, o) {
    ...
    if (o.merge) s = new at(u.zt), a = u.fieldTransforms; else if (o.mergeFields) {
        for (var f = [], h = 0, l = o.mergeFields; h < l.length; h++) {
            var p = ga(e, l[h], n);
            if (!u.contains(p)) throw new M$1(V$1.INVALID_ARGUMENT, "Field '" + p + "' is specified in your field mask but missing from your input data.");
            _a(f, p) || f.push(p);
        }
...
/** Parse update data from a list of field/value arguments. */ function la(t, e, n, r, i, o) {
    ...
    if (o.length % 2 != 0) throw new M$1(V$1.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) s.push(ga(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var f = [], h = new Ct, l = s.length - 1; l >= 0; --l) if (!_a(f, s[l])) {
        var p = s[l], d = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
 ...
 */ function da$1(t, e) {
    ...
    return function(t, e) {
        ...
        if (t instanceof X$1) {
            ...
            n = new X$1(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: qn(e.Kt, n)
            };
        }
        ...
        throw e.K_("Unsupported field value: " + Ms(t));
    }(t, e);
}
...
function ya(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof X$1 || t instanceof Ys || t instanceof U$1 || t instanceof Gs || t instanceof Os);
}
 ...
 * evaluated.
 */ function ba$1(t, e, n) {
    if (e.search(wa$1) >= 0) throw Ia$1("Invalid field path (" + e + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return (new (ks.bind.apply(ks, __spreadArrays([ void 0 ], e.split("."))))).d_;
    } catch (r) {
        throw Ia$1("Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
}

function Ia$1(t, e, n, r, i) {
    var o = r && !r.nt(), u = void 0 !== i, s = "Function " + e + "() called with invalid data";
    n && (s += " (via `toFirestore()`)");
    var a = "";
    return (o || u) && (a += " (found", o && (a += " in field " + r), u && (a += " in document " + i), 
    a += ")"), new M$1(V$1.INVALID_ARGUMENT, (s += ". ") + t + a)
 ...
 */ var Ea$1 = /** @class */ function() {
    ...
    return t.prototype.ef = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    if (this.nf(), this.mutations.length > 0) throw new M$1(V$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return __awaiter(this, void 0, void 0, (function() {
                            var n, r, i, o, u, s;
                            return __generator(this, (function(a) {
                                switch (a.label) {
                                  case 0:
                                    return n = D$1(t), r = Qn(n.Kt) + "/documents", i = {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((e = r.sent()).forEach((function(t) {
                        t instanceof Mt || t instanceof Vt ? n.sf(t) : S$1();
                    })), e) ];
                }
            }));
        }));
        ...
        if (n) {
            ...
            throw new M$1(V$1.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.rf = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new M$1(V$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    t.prototype.df = function() {
        if (this.fs.wf) throw new M$1(V$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
        this.fs.Ef();
        var e = new vr;
                        ...
                        return function(t, e) {
                            return __awaiter(this, void 0, void 0, (function() {
                                ...
                                return __generator(this, (function(i) {
                                    switch (i.label) {
                                      case 0:
                                        return (n = D$1(t)).fs.Af(), E$1("RemoteStore", "RemoteStore received new credentials"), 
                                        r = fu(n), 
                                        // Tear down and re-create our network streams. This will ensure we get a
                                        // fresh auth token for the new user and re-fill the write pipeline with
                                        // new mutations from the LocalStore (since mutations are per-user).
                                        n.Fh.add(3 /* CredentialChange */), [ 4 /*yield*/ , ru(n) ];
                                      ...
                                      case 2:
                                        return i.sent(), n.Fh.delete(3 /* CredentialChange */), [ 4 /*yield*/ , nu(n) ];
                    ...
                    return r = function(t, e, n, r, i) {
                        var o = new xs({
                            next: function(o) {
                                ...
                                i.reject(new M$1(V$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : s && o.fromCache && r && "server" === r.source ? i.reject(new M$1(V$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(o);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                        }), u = new Lu(se(n.path), o, {
                    ...
                    return r = function(t, e, n, r, i) {
                        var o = new xs({
                            next: function(n) {
                                ...
                                e.ys((function() {
                                    return ku(t, u);
                                })), n.fromCache && "server" === r.source ? i.reject(new M$1(V$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
 ...
 */
...
}(), Ua$1 = -1, qa$1 = /** @class */ function(t) {
    /** @hideconstructor */
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).Mf = new Ma$1, r.w_ = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
    return __extends$1(e, t), e.prototype.b_ = function() {
        ...
        ja$1(this), this.Lf.terminate();
    }, e;
}(zs);

function Fa$1(t) {
    return t.Lf || ja$1(t), t.Lf.df(), t.Lf;
}
 ...
 */
function Ga$1(t) {
    if (t.R_ || t.P_) throw new M$1(V$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 * limitations under the License.
 */ function Wa$1(t) {
    if (ce(t) && 0 === t.Nt.length) throw new M$1(V$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var $a$1 = /** @class */ function(t) {
    ...
    return __extends$1(e, t), e.prototype.Yf = function(t) {
        var e = ra$1(t.firestore), n = function(t, e, n, r, i, o, u) {
            var s;
            if (i.ht()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            return function(t, e) {
                if (e.xt()) {
                    var n = he(t);
                    if (null !== n && !n.isEqual(e.field)) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = fe(t);
 ...
 */
                ...
                throw i === e.op ? new M$1(V$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new M$1(V$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
    ...
    return __extends$1(e, t), e.prototype.Yf = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new ee(e, n);
            return function(t, e) {
                if (null === fe(t)) {
...
function nc$1(t, e, n, r) {
    if (n[0] instanceof q$1 && (n[0] = n[0]._), n[0] instanceof Ka$1) return function(t, e, n, r, i) {
        if (!r) throw new M$1(V$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], u = 0, s = pe(t); u < s.length; u++) {
            ...
            if (a.field.ht()) o.push(At(e, r.key)); else {
                ...
                if (pt(c)) throw new M$1(V$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var f = a.field.ot();
                    throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + f + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        var u = t.Nt;
        if (i.length > u.length) throw new M$1(V$1.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var s = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (u[a].field.ht()) {
                if ("string" != typeof c) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!le(t) && -1 !== c.indexOf("/")) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var f = t.path.child(et.ct(c));
                if (!it.Et(f)) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + f + "' is not because it contains an odd number of segments.");
                var h = new it(f);
                s.push(At(e, h));
            } else {
                var l = pa$1(n, r, c);
...
function rc$1(t, e, n) {
    if (n instanceof q$1 && (n = n._), "string" == typeof n) {
        if ("" === n) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!le(e) && -1 !== n.indexOf("/")) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(et.ct(n));
        if (!it.Et(r)) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return At(t, new it(r));
    }
    if (n instanceof Gs) return At(t, n.S_);
    throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Ms(n) + ".");
}
 ...
 * array requirements.
 */ function ic$1(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function oc$1(t, e, n) {
    if (!n.isEqual(e)) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
...
var ac$1 = /** @class */ function(t) {
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this.ud.Ne) throw new M$1(V$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */ function yc$1(t, e, n) {
    ...
    t = Us(t, Gs);
    var o = Us(t.firestore, qa$1), u = ra$1(o);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    return e instanceof q$1 && (e = e._), gc$1(o, [ ("string" == typeof e || e instanceof ks ? la(u, "updateDoc", t.S_, e, n, r) : ha$1(u, "updateDoc", t.S_, e)).F_(t.S_, Fe.exists(!0)) ]);
}
 ...
 */ function mc$1(t) {
    ...
    if (t instanceof Gs) c = Us(t.firestore, qa$1), f = se(t.S_.path), a = {
        next: function(e) {
            i[s] && i[s](wc$1(c, t, e));
        },
        error: i[s + 1],
 ...
 */ var bc$1 = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        this.Ed();
        var r = Ic$1(t, this.zf), i = sc$1(r.v_, e, n), o = ia(this.wd, "WriteBatch.set", r.S_, i, null !== r.v_, n);
        return this.fd.push(o.F_(r.S_, Fe.Wt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this.Ed();
        var o, u = Ic$1(t, this.zf);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        ...
        this.fd.push(o.F_(u.S_, Fe.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this.dd) throw new M$1(V$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();

function Ic$1(t, e) {
    if (t instanceof q$1 && (t = t._), t.firestore !== e) throw new M$1(V$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ var _c = /** @class */ function(t) {
     ...
     */    return __extends$1(e, t), e.prototype.get = function(e) {
        var n = this, r = Ic$1(e, this.zf), i = new vc$1(this.zf);
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Ic$1(t, this.zf), r = new ac$1(this.zf);
        return this.Td.ef([ n.S_ ]).then((function(t) {
            if (!t || 1 !== t.length) return S$1();
            var i = t[0];
            if (i instanceof Mt) return new Ka$1(e.zf, r, n.S_, null, n.v_);
            if (i instanceof Vt) return new Ka$1(e.zf, r, i.key, i, n.v_);
            throw S$1();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Ic$1(t, this.zf), i = sc$1(r.v_, e, n), o = ia(this.wd, "Transaction.set", r.S_, i, null !== r.v_, n);
    ...
    return t.prototype.enableIndexedDbPersistence = function(t, e) {
        ...
        return function(t) {
            Ga$1(t = Us(t, qa$1));
            var e = Fa$1(t), n = t.p_(), r = new As;
            return za$1(e, r, new Ns(r, n.cacheSizeBytes));
        }(t._);
    }, t.prototype.clearIndexedDbPersistence = function(t) {
        return function(t) {
            var e = this;
            if (t.R_ && !t.P_) throw new M$1(V$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
            var n = new vr;
 ...
 */;
    ...
    return __extends$1(e, t), Object.defineProperty(e.prototype, "I_", {
        ...
        "firestore.googleapis.com" !== this._.V_().host && N$1("Host has been set in both settings() and useEmulator(), emulator host will be used"), 
        this.settings({
            host: t + ":" + e,
            ssl: !1,
            merge: !0
                ...
                return __awaiter(e, void 0, void 0, (function() {
                    ...
                    return __generator(this, (function(r) {
                        switch (r.label) {
                          ...
                          case 2:
                            return n = r.sent(), [ 2 /*return*/ , (e.po(!0), function(t) {
                                var e = D$1(t);
                                return e.Fh.delete(0 /* UserDisabled */), nu(e);
                            }(n)) ];
                        }
                    }));
                }));
        ...
        /** Disables the network connection. Pending operations will not complete. */ (Fa$1(Us(this._, qa$1)));
                            ...
                            return n = r.sent(), [ 2 /*return*/ , (e.po(!1), function(t) {
                                return __awaiter(this, void 0, void 0, (function() {
                                    ...
                                    return __generator(this, (function(n) {
                                        switch (n.label) {
                                          case 0:
                                            return (e = D$1(t)).Fh.add(0 /* UserDisabled */), [ 4 /*yield*/ , ru(e) ];
 ...
 */ (Fa$1(Us(this._, qa$1)));
        ...
        var e = !1, n = !1;
        return t && Ls("synchronizeTabs", e = !!t.synchronizeTabs, "experimentalForceOwningTab", n = !!t.experimentalForceOwningTab), 
 ...
 */;
            }(Fa$1(t = Us(t, qa$1)), uc$1(e) ? e : {
                next: e
            });
        }(this._, t);
    }, Object.defineProperty(e.prototype, "app", {
        get: function() {
            if (!this.md) throw new M$1(V$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.md;
        },
        enumerable: !1,
        configurable: !0
        ...
        try {
            return new Rc$1(this, function(t, e) {
                if (t = Us(t, zs), Ps("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new Bs(t, 
                /* converter= */ null, 
                /**
 ...
 */
        ...
        var t = this;
        return Fa$1(this._), new xc(new bc$1(this._, (function(e) {
            return gc$1(t._, e);
        })));
    }, e.prototype.loadBundle = function(t) {
        throw new M$1(V$1.FAILED_PRECONDITION, '"loadBundle()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e.prototype.namedQuery = function(t) {
        throw new M$1(V$1.FAILED_PRECONDITION, '"namedQuery()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e;
    ...
    return __extends$1(e, t), e.prototype.Uf = function(t) {
        return new z$1(new U$1(t));
    }, e.prototype.Qf = function(t) {
        var e = this.Gf(t, this.firestore.I_);
        return Dc$1.Ad(e, this.firestore, /* converter= */ null);
    }, e;
}(Ba$1);
 ...
 */ var Sc$1 = /** @class */ function(t) {
    ...
    return __extends$1(e, t), e.prototype.get = function(t) {
        ...
        return this._.get(n).then((function(t) {
            return new Cc$1(e.zf, t);
        }));
    }, e.prototype.set = function(t, e, n) {
        var r = qc$1(t);
        return n ? (Cs("Transaction.set", n), this._.set(r, e, n)) : this._.set(r, e), this;
    ...
    return __extends$1(e, t), e.Rd = function(t, n, r) {
        if (t.length % 2 != 0) throw new M$1(V$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.ot() + " has " + t.length);
        ...
        get: function() {
            return new Uc$1(this.firestore, this._.parent);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "path", {
        ...
        try {
            return new Uc$1(this.firestore, Hs(this._, t));
        } catch (t) {
        ...
        try {
            return function(t, e, n) {
                t = Us(t, Gs);
                var r = Us(t.firestore, qa$1), i = sc$1(t.v_, e, n);
                return gc$1(r, [ ia(ra$1(r), "setDoc", t.S_, i, null !== t.v_, n).F_(t.S_, Fe.Wt()) ]);
            }(this._, t, e);
        } catch (t) {
        ...
        return gc$1(Us((t = this._).firestore, qa$1), [ new nn(t.S_, Fe.Wt()) ]);
        var t;
        /**
 ...
 */    }, e.prototype.onSnapshot = function() {
        ...
        var r = Oc$1(e), i = Pc$1(e, (function(e) {
            return new Cc$1(t.firestore, new fc$1(t.firestore._, t.Hf, e.S_, e.Jf, e.metadata, t._.v_));
        }));
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = Us(t, Gs);
            var e = Us(t.firestore, qa$1), n = Fa$1(e), r = new vc$1(e);
            return function(t, e) {
                var n = this, r = new vr;
                return t.fs.ys((function() {
                    return __awaiter(n, void 0, void 0, (function() {
                                    ...
                                    return __awaiter(this, void 0, void 0, (function() {
                                        ...
                                        return __generator(this, (function(o) {
                                            switch (o.label) {
                                              ...
                                              case 1:
                                                return (i = o.sent()) instanceof Vt ? n.resolve(i) : i instanceof Mt ? n.resolve(null) : n.reject(new M$1(V$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                [ 3 /*break*/ , 3 ];
            ...
            t = Us(t, Gs);
            var e = Us(t.firestore, qa$1);
            return Ra$1(Fa$1(e), t.S_, {
                source: "server"
            }).then((function(n) {
                return wc$1(e, t, n);
            }));
            ...
            t = Us(t, Gs);
            var e = Us(t.firestore, qa$1);
            return Ra$1(Fa$1(e), t.S_).then((function(n) {
                return wc$1(e, t, n);
            }));
        }(this._)).then((function(t) {
            return new Cc$1(e.firestore, new fc$1(e.firestore._, e.Hf, t.S_, t.Jf, t.metadata, e._.v_));
        }));
    }, e.prototype.withConverter = function(t) {
...
var Cc$1 = /** @class */ function(t) {
    ...
    return __extends$1(e, t), Object.defineProperty(e.prototype, "ref", {
        get: function() {
            return new Dc$1(this.zf, this._.ref);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "id", {
     ...
     */
        function(t) {
                                    ...
                                    return __awaiter(this, void 0, void 0, (function() {
                                        ...
                                        return __generator(this, (function(a) {
                                            switch (a.label) {
                                              ...
                                              case 1:
                                                return s = a.sent(), r = new ju(e, s.Pc), i = r.dl(s.documents), o = r.Ti(i, 
            ...
            return new Mc$1(e.firestore, new lc$1(e.firestore._, e.Hf, e._, t.ud));
        }));
    }, e.prototype.onSnapshot = function() {
        for (var t = this, e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
        var r = Oc$1(e), i = Pc$1(e, (function(e) {
            return new Mc$1(t.firestore, new lc$1(t.firestore._, t.Hf, t._, e.ud));
        }));
        return mc$1(this._, r, i);
    }, e.prototype.withConverter = function(t) {
        return new e(this.firestore, this._.withConverter(t));
    ...
    return __extends$1(e, t), Object.defineProperty(e.prototype, "type", {
        ...
        get: function() {
            return new Lc$1(this.zf, this._.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return __extends$1(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        get: function() {
            var t = this._.parent;
            return t ? new Dc$1(this.firestore, t) : null;
        },
        enumerable: !1,
        configurable: !0
    }), e.prototype.doc = function(t) {
        try {
            return new Dc$1(this.firestore, void 0 === t ? Js(this._) : Js(this._, t));
        } catch (t) {
        ...
        var e = this;
        return function(t, e) {
            var n = Us(t.firestore, qa$1), r = Js(t), i = sc$1(t.v_, e);
            return gc$1(n, [ ia(ra$1(t.firestore), "addDoc", r.S_, i, null !== t.v_, {}).F_(r.S_, Fe.exists(!1)) ]).then((function() {
                return r;
            }));
        }(this._, t).then((function(t) {
            return new Dc$1(e.firestore, t);
        }));
    }, e.prototype.isEqual = function(t) {
...
function qc$1(t) {
    return t instanceof q$1 && (t = t._), Us(t, Gs);
}
...
var P$2 = {
    ...
    Transaction: Sc$1,
    WriteBatch: xc,
    DocumentReference: Dc$1,
    DocumentSnapshot: Cc$1,
    Query: Rc$1,
    QueryDocumentSnapshot: Lc$1,
    QuerySnapshot: Mc$1,
    CollectionReference: Uc$1,
    FieldPath: Fc$1,
    FieldValue: jc$1,
    setLogLevel: Ac$1,
 ...
 */
    ...
    })), e.registerVersion("@firebase/firestore", "2.1.1");
}

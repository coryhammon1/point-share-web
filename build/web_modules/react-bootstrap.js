...
import { p as propTypes$7 } from './common/index-e7a14e6e.js';
...
var propTypes = {
  label: propTypes$7.string.isRequired,
...
var propTypes$1 = {
   ...
   * }) => React.Element}
   */
  children: propTypes$7.func.isRequired,
   ...
   */
  flip: propTypes$7.bool,
  usePopper: propTypes$7.oneOf([true, false]),

  /**
   * A set of popper options and props passed directly to react-popper's Popper component.
   */
  popperConfig: propTypes$7.object,
...
var propTypes$3 = {
   ...
   */
  drop: propTypes$7.oneOf(['up', 'left', 'right', 'down']),
   ...
   */
  focusFirstItemOnShow: propTypes$7.oneOf([false, true, 'keyboard']),
   ...
   * e.g. ` > li:not('.disabled')`
   */
  itemSelector: propTypes$7.string,
...
var alignDirection = propTypes$7.oneOf(['left', 'right']);
var alignPropType = propTypes$7.oneOfType([alignDirection, propTypes$7.shape({
  sm: alignDirection
}), propTypes$7.shape({
  md: alignDirection
}), propTypes$7.shape({
...
var DropdownMenu$1 = react.forwardRef(function (_ref, ref) {
  ...
  var isNavbar = react.useContext(context$1);
  ...
  menuProps.ref = useMergedRefs(popperRef, useMergedRefs(useWrappedRefWithWarning(ref), menuProps.ref));
...
FormImpl.defaultProps = defaultProps$c;
...
Container.defaultProps = defaultProps$d;
...
AbstractNavItem.defaultProps = defaultProps$e;
...
var propTypes$5 = {
   ...
   */
  container: propTypes$7.any,

  /**
   * A callback fired when the Modal is opening.
   */
  onShow: propTypes$7.func,
   ...
   */
  onHide: propTypes$7.func,

  /**
   * Include a backdrop component.
   */
  backdrop: propTypes$7.oneOfType([propTypes$7.bool, propTypes$7.oneOf(['static'])]),
   ...
   * ```
   */
  renderBackdrop: propTypes$7.func,
   ...
   */
  onEscapeKeyDown: propTypes$7.func,
   ...
   */
  containerClassName: propTypes$7.string,

  /**
   * Close the modal when escape key is pressed
   */
  keyboard: propTypes$7.bool,

  /**
   * A `react-transition-group@2.0.0` `<Transition/>` component used
   * to control animations for the dialog component.
   */
  transition: propTypes$7.elementType,

  /**
   * A `react-transition-group@2.0.0` `<Transition/>` component used
   * to control animations for the backdrop components.
   */
  backdropTransition: propTypes$7.elementType,
   ...
   * accessible to assistive technologies, like screen readers.
   */
  enforceFocus: propTypes$7.bool,

  /**
   * When `true` The modal will restore focus to previously focused element once
   * modal is hidden
   */
  restoreFocus: propTypes$7.bool,
   ...
   */
  restoreFocusOptions: propTypes$7.shape({
    preventScroll: propTypes$7.bool
  }),
   ...
   */
  manager: propTypes$7.instanceOf(ModalManager)
};
...
ModalHeader.defaultProps = defaultProps$f;
...
Modal$1.defaultProps = defaultProps$g;
...
NavbarToggle.defaultProps = defaultProps$i;
...
Navbar.defaultProps = defaultProps$j;
...
Row.displayName = 'Row';
Row.defaultProps = defaultProps$k;
...
export { Alert, Button, Card, CardColumns, CardDeck, CardGroup, Col, Container, FormImpl as Form, Modal$1 as Modal, NavDropdown, Navbar, Row, Spinner, Table };
